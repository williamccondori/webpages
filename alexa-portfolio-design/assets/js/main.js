...
skillsHeader.forEach((x) => x.addEventListener("click", toggleSkills));
...
let modal = function (modalView) {
  modalViews[modalView].classList.add("active-modal");
};
...
const getCurrentIcon = () => {
  return themeButtonIcon.classList.contains(iconTheme) ? "uil-moon" : "uil-sun";
};
